...
def test_get_weather_fortest1():
    filepath = 'C:/Users/0/PycharmProjects/10.2-Home_work_test-/data/for_test_1.json'
    assert get_weather(filepath) == [
...
def test_get_weather_operations():
    filepath = 'C:/Users/0/PycharmProjects/10.2-Home_work_test-/data/operations.json'
    assert get_weather(filepath) == [
  {
    "id": 441945886,
    "state": "EXECUTED",
